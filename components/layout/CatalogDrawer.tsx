...
const collections = [

    {
        ...
        subcategories: ['All New', 'This Week', 'Last Month']
...

    {
        ...
        subcategories: ['Bomber Jackets', 'Leather Jackets', 'Denim Jackets', 'Winter Coats']
...

    {
        ...
        subcategories: ['Formal Blazers', 'Casual Blazers', 'Double Breasted']
...

    {
        ...
        subcategories: ['Overcoats', 'Trench Coats', 'Parkas', 'Raincoats']
...

    {
        ...
        subcategories: ['Casual Shirts', 'Formal Shirts', 'T-Shirts', 'Polo Shirts']
...

    {
        ...
        subcategories: ['Bags', 'Belts', 'Wallets', 'Scarves']
                                        ...
                                        <div className="px-4 pb-4 space-y-2">
                                            ...
                                            {collection.subcategories.map((subcategory) => (
                                                ...
                                                <Link
                                                    ...
                                                    href={`/catalog?category=${subcategory.toLowerCase().replace(' ', '-')}`}
