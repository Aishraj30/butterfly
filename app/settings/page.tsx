      ...
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10">
          <div className="flex flex-col gap-2">
            ...
            <h1 className="font-serif text-4xl font-semibold tracking-tight text-foreground sm:text-5xl">Account Settings</h1>
          ...
          <div className="space-y-6 lg:col-span-8">
            <Card className="border-amber-200/60 dark:border-amber-900/40">
              <CardHeader className="pb-4">
                ...
                <CardDescription>These settings will be enabled in the next step.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="rounded-lg border bg-card p-4">
                  <div className="text-sm font-medium text-foreground">Notifications</div>
                  <div className="mt-1 text-sm text-muted-foreground">Email & order updates preferences will appear here.</div>
                </div>
                <div className="rounded-lg border bg-card p-4">
                  <div className="text-sm font-medium text-foreground">Security</div>
                  <div className="mt-1 text-sm text-muted-foreground">Password change & session management will appear here.</div>
                </div>
              </CardContent>
            </Card>
          </div>
